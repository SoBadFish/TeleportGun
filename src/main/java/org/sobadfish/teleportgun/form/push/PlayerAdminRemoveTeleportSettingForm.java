 ...
 * 此页面为传送点的移除页面
 * */
public class PlayerAdminRemoveTeleportSettingForm extends CustomInputForm {

    public boolean isPublic;

    public PlayerAdminRemoveTeleportSettingForm(String title, Player playerInfo, Item item, boolean isPublic) {
